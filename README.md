...
## Extraction
To extract the audio snapshots/segments and the corresponding labels for a dataset of your choice, go to the extraction folder and use the following code (for MAESTRO) as a guide:
