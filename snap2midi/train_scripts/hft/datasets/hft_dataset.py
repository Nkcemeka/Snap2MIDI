"""
    ...
    Date: 07/10/2025
    Description: This script defines the HFTDataset class for Sony's hFT-Transformer.
"""
...
class HFTDataset(Dataset):
    ...
    """
    def __init__(self, n_slice: int, base_path: str, config: dict, split: str = Optional[None]):
        """
