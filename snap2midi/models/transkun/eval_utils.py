import mir_eval
import numpy as np
from .utilities import prepareIntervalsNoQuantize
...
def computeFrameScore(estimated, gt, eventTypes):
    ...
    intervalsA = prepareIntervalsNoQuantize(estimated, eventTypes)["intervals"]
    intervalsB = prepareIntervalsNoQuantize(gt,  eventTypes)["intervals"]
