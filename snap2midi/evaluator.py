    ...
    def evaluate_kong(self, checkpoint_name: str = "checkpoint_180000.pt", extend_pedal: bool = True, factors: list = [16, 32, 32], \
        ...
        """
            ...
            -----------
                ...
                momentum (float): 
                    Momentum value for the model. Default is 0.01.
    ...
    def evaluate_hft(self, checkpoint_name: str = "checkpoint_7.pt", margin_b: int = 32, margin_f: int = 32, \
        ...
        """
            ...
            -----------
                ...
                d (int): 
                    Dimension of model. Default is 256.
                pff_dim (int): 
                    Dimension of position-wise feedforward layers. Default is 512.
                enc_layer (int): 
                ...
                enc_head (int): 
                    Number of attention heads in encoder. Default is 4.
                dec_head (int): 
                    Number of attention heads in decoder. Default is 4.
                weight_A (float): 
