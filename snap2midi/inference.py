    ...
    def inference_oaf(self, audio_path: str, checkpoint_path: str, filename: str | None = "output",  sample_rate: int = 16000,\
        ...
        """
            ...
            -----------
                ...
                mel_n_fft (int): 
                    Number of FFT components for Mel spectrogram. Default is 2048.
                hop_length (int): 
                    Hop length for Mel spectrogram. Default is 512.
                window_size (float): 
                    Window size for feature extraction in seconds. Default is 20.0.
                feature_str (str): 
    ...
    def inference_kong(self, audio_path: str, checkpoint_note_path: str, checkpoint_pedal_path: str, filename: str|None = "output", factors: list = [16, 32, 32], \
        ...
        """
            ...
            -----------
                ...
                cmp (int): 
                    Number of components for PCA. Default is 48.
                momentum (float): 
                    Momentum for batch normalization. Default is 0.01.
                sample_rate (int): 
                    Sample rate of the input audio. Default is 16000.
                window_size (float): 
    ...
    def inference_hft(self, audio_path: str, checkpoint_path: str, filename: str | None = "output", margin_b: int = 32, margin_f: int = 32, \
        ...
        """
            ...
            -----------
                ...
                margin_f (int): 
                    Front margin for input feature. Default is 32.
                n_bins (int): 
                    Number of frequency bins for input feature. Default is 256.
                fft_bins (int): 
                    Number of FFT components for Mel spectrogram. Default is 2048.
                window_length (int): 
                    Window length for Mel spectrogram. Default is 2048.
                n_slice (int): 
                    Number of slices for input feature. Default is 16.
                frame_threshold (float): 
                    Threshold for frame prediction. Default is 0.5.
                onset_threshold (float): 
                    Threshold for onset prediction. Default is 0.5.
                offset_threshold (float): 
                ...
                frame_rate (int): 
                    Frame rate for the model. Default is 100.
                shift (int): 
                    Shift or offset for HFT inference. Default is 32.
                num_velocity (int): 
                ...
                hop_sample (int): 
                    Hop length for Mel spectrogram. Default is 256.
                mel_bins (int): 
                    Number of Mel frequency bins. Default is 256.
                sr (int): 
                    Sample rate of the input audio. Default is 16000.
                cnn_channel (int): 
                ...
                d (int): 
                    Model dimension. Default is 256.
                pff_dim (int): 
                    Position-wise feed-forward dimension. Default is 512.
                enc_layer (int): 
                ...
                enc_head (int): 
                    Number of encoder attention heads. Default is 4.
                dec_head (int): 
                ...
                log_offset (float): 
                    Log offset for feature extraction. Default is 1e-8.
                pad_mode (str): 
                    Padding mode for input feature. Default is "constant".
